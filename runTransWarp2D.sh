...
declare -a VARIABLE=("pzmu%s_vs_ptmu%s" "tpi%s_vs_pmu%s" "tpi%s_vs_thetapi_deg%s" "ptmu%s_vs_tpi%s" )
#declare -a VARIABLE=()
declare -a warps=("WARP1")
#declare -a VARIABLE=("tpi")
#declare -a warps=("NOMINAL" "WARP1" "WARP2" "WARP3")
...
Ximaxaxis=(5000 5000 5000 5000 5000 5000 5000)
true_tag="_true"
reco_tag=""
DATE="20230524"
#MIGRATION_FILE=$1
