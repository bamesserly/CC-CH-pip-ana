...
void crossSectionDataFromFile(int signal_definition_int = 0,
  ...
  // I/O
  TFile fin("MCXSecInputs_20230902_ME1A_HadronContained_Helicity_Nodes_GoodMomentum_Michel_Aaronbinnig.root", "READ");
  std::cout << "Reading input from " << fin.GetName() << endl;

  TFile fout("DataXSecInputs_20230902_ME1A_HadronContained_Helicity_Nodes_GoodMomentum_Michel_Aaronbinnig.root", "RECREATE");
