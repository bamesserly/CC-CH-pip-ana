...
void crossSectionDataFromFile(int signal_definition_int = 0,
  ...
  // I/O
  TFile fin("MCXSecInputs_Mpions_20230621_ME1A_Multimode_mixed_addingCuts.root", "READ");
  std::cout << "Reading input from " << fin.GetName() << endl;

  TFile fout("DataXSecInputs_Mpions_20230621_ME1A_Multimode_mixed_addingCuts.root", "RECREATE");
