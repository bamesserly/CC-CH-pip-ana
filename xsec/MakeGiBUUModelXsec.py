...
pzmu_edges  = array('d',[0., 1.e3, 2.e3,  3.e3,  4.e3, 5.e3,6.0e3, 8.e3, 10.e3, 15.e3, 20.e3])
...
pzmu    = PlotUtils.MnvH1D("pzmu"   ,";p_{#mu,||};#frac{d#sigma}{dp_{#mu,||}}"       ,len(pzmu_edges)-1,pzmu_edges);
