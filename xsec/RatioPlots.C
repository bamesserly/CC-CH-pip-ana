...
/*;
  ...
  if (true){
    ...
    for (auto var : variables) {
      ...
      PlotUtils::MnvH1D* num_mc_Effden = (PlotUtils::MnvH1D*)fin.Get(Form("effden_%s_true", name.c_str()));
      PlotUtils::MnvH1D* denom_mc_Effden = (PlotUtils::MnvH1D*)fin1.Get(Form("effden_%s_true", name.c_str()));
