...
// Main
//==============================================================================
void RatioPlots(int signal_definition_int = 0, int plot_errors = 1) {
  // Infiles
  //  TFile fin("MCXSecInputs_20231212_ME1A_trackless_noSys_p3.root", "READ");
  //  TFile
  //  fin1("MCXSecInputs_20231213_ME1A_trackless_noSys_fixedMuonCut_p3.root",
  //  "READ");
  TFile fin(
      "DataXSecInputs_20231213_ME1A_trackless_noSys_fixedMuonCut_noIsoProngCut_"
      "p4.root",
      "READ");
  TFile fin1(
      "DataXSecInputs_20231213_ME1A_trackless_noSys_fixedMuonCut_noIsoProngCut_"
  ...
  //  TFile fin1("DataXSecInputs_20231212_ME1A_trackless_noSys_p3.root",
  //  "READ");
  ...
  if (true) {
    ...
    double data_norm =
        data_pot->GetBinContent(1) / data_pot_1->GetBinContent(1);
    ...
    for (auto var : variables) {
      ...
      PlotUtils::MnvH1D* num_data_sel =
          (PlotUtils::MnvH1D*)fin.Get(Form("selection_data_%s", name.c_str()));
      PlotUtils::MnvH1D* denom_data_sel =
          (PlotUtils::MnvH1D*)fin1.Get(Form("selection_data_%s", name.c_str()));
      PlotUtils::MnvH1D* num_mc_sel =
          (PlotUtils::MnvH1D*)fin.Get(Form("selection_mc_%s", name.c_str()));
      PlotUtils::MnvH1D* denom_mc_sel =
          (PlotUtils::MnvH1D*)fin1.Get(Form("selection_mc_%s", name.c_str()));
      PlotUtils::MnvH1D* num_mc_noWcut =
          (PlotUtils::MnvH1D*)fin.Get(Form("noWcut_%s", name.c_str()));
      PlotUtils::MnvH1D* denom_mc_noWcut =
          (PlotUtils::MnvH1D*)fin1.Get(Form("noWcut_%s", name.c_str()));
      PlotUtils::MnvH1D* num_mc_Effnum =
          (PlotUtils::MnvH1D*)fin.Get(Form("effnum_%s", name.c_str()));
      PlotUtils::MnvH1D* denom_mc_Effnum =
          (PlotUtils::MnvH1D*)fin1.Get(Form("effnum_%s", name.c_str()));
      PlotUtils::MnvH1D* num_data_BGsub =
          (PlotUtils::MnvH1D*)fin.Get(Form("bg_subbed_data_%s", name.c_str()));
      PlotUtils::MnvH1D* denom_data_BGsub =
          (PlotUtils::MnvH1D*)fin1.Get(Form("bg_subbed_data_%s", name.c_str()));
      PlotUtils::MnvH1D* num_data_unfolded =
          (PlotUtils::MnvH1D*)fin.Get(Form("unfolded_%s", name.c_str()));
      PlotUtils::MnvH1D* denom_data_unfolded =
          (PlotUtils::MnvH1D*)fin1.Get(Form("unfolded_%s", name.c_str()));
      PlotUtils::MnvH1D* num_mc_Effden =
          (PlotUtils::MnvH1D*)fin.Get(Form("effden_%s_true", name.c_str()));
      PlotUtils::MnvH1D* denom_mc_Effden =
          (PlotUtils::MnvH1D*)fin1.Get(Form("effden_%s_true", name.c_str()));

      PlotUtils::MnvH1D* num_mc_Eff =
          (PlotUtils::MnvH1D*)fin.Get(Form("efficiency_%s", name.c_str()));
      PlotUtils::MnvH1D* denom_mc_Eff =
          (PlotUtils::MnvH1D*)fin1.Get(Form("efficiency_%s", name.c_str()));
      PlotUtils::MnvH1D* num_data_xsec =
          (PlotUtils::MnvH1D*)fin.Get(Form("cross_section_%s", name.c_str()));
      PlotUtils::MnvH1D* denom_data_xsec =
          (PlotUtils::MnvH1D*)fin1.Get(Form("cross_section_%s", name.c_str()));
      PlotUtils::MnvH1D* num_mc_xsec = (PlotUtils::MnvH1D*)fin.Get(
          Form("mc_cross_section_%s", name.c_str()));
      PlotUtils::MnvH1D* denom_mc_xsec = (PlotUtils::MnvH1D*)fin1.Get(
          Form("mc_cross_section_%s", name.c_str()));
      PlotRatio(num_data_sel, denom_data_sel, name, data_norm, "Data_Sel",
                false);
      denom_mc_sel->Scale(mc_norm);
      PlotRatio(num_mc_sel, denom_mc_sel, name, 1., "MC_Sel", false);
      PlotRatio(num_mc_noWcut, denom_mc_noWcut, name, mc_norm, "MC_noWcut",
                false);
      ...
      PlotRatio(num_data_BGsub, denom_data_BGsub, name, data_norm, "BGSub",
                false);
      PlotRatio(num_mc_Eff, denom_mc_Eff, name, 1., "Efficiency", false);
      PlotRatio(num_data_unfolded, denom_data_unfolded, name, data_norm,
                "Unfolding", false);
