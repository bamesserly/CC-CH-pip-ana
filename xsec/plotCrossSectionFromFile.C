...
void plotCrossSectionFromFile(int signal_definition_int = 0,
                              int plot_errors = 1) {
  // Infiles
  TFile fin("DataXSecInputs_0110_ME1A_0_2023-01-31.root",
            "READ");
  ...
  {  // remove unwanted variables
    ...
    */
    ...
    //  PlotUtils::MnvH1D* q2_Aaron_tesis =
    //      new PlotUtils::MnvH1D("q2_Aaron_tesis", "q2_Aaron_tesis", nbins,
    //                            CCPi::GetBinning("q2_GeV").GetArray());
    ...
    //  //    for (int i = 0; i < nbins; ++i)
    //  //      std::cout << "Min " << q2_Aaron_tesis->GetBinLowEdge(i+1) << " max "
    //  //      << q2_Aaron_tesis->GetXaxis()->GetBinLowEdge(i+1) +
    //  //      q2_Aaron_tesis->GetXaxis()->GetBinWidth(i+1)  << " BinContent " <<
    //  //      q2_Aaron_tesis->GetBinContent(i+1) << "\n";

    //  PlotUtils::MnvH1D* BenXSecMC =
    //      (PlotUtils::MnvH1D*)fin.Get("mc_cross_section_q2_GeV");
    //  PlotUtils::MnvH1D* AaronXSecMC =
    //      (PlotUtils::MnvH1D*)finCCPi.Get("mc_cross_section_q2_GeV");
    //  PlotUtils::MnvH1D* BenXSecdata =
    //      (PlotUtils::MnvH1D*)fin.Get("cross_section_q2_GeV");
    //  PlotUtils::MnvH1D* AaronXSecdata =
    //      (PlotUtils::MnvH1D*)finCCPi.Get("cross_section_q2_GeV");

    //  PlotRatio2(BenXSecMC, AaronXSecMC, q2_Aaron_tesis, "Q^2", 1., "mc", true,
    //             true);
    //  PlotRatio2(BenXSecdata, AaronXSecdata, q2_Aaron_tesis, "Q^2", 1., "data",
    //             true, true);
    //  PlotRatio2(BenXSecMC, AaronXSecMC, q2_Aaron_tesis, "Q^2", 1., "mc", true,
    //             true);
    //  //    for (int i = 0; i < nbins; ++i)
    //  //      std::cout << q2_Aaron_tesis->GetBinContent(i+1) << " " <<
    //  //      BenXSecMC->GetBinContent(i+1) << " " <<
    //  //      AaronXSecMC->GetBinContent(i+1) << " " <<
    //  //      BenXSecdata->GetBinContent(i+1) << " " <<
    //  //      AaronXSecdata->GetBinContent(i+1) << "\n";
    //}
