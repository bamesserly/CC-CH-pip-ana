#ifndef FillFunctions_h
#define FillFunctions_h
...
// TODO write
// Streamline signatures, too
std::tuple<bool, VertUniverseInfo> CheckBasicCuts(const CCPiEvent&, const bool is_mc, const SignalDefinition&, const VertUniverseInfo&);
std::tuple<vector<PionCandidate>, VertUniverseInfo> GetPionCandidates(const CCPiEvent&, const bool is_mc, const SignalDefinition&, const VertUniverseInfo&);
