...
class HadronVariable : public Variable {
 private:
  typedef std::function<double(const CVUniverse&, int)>
 ...
 public:
  ...
  //==========================================================================
  HadronVariable(
      const std::string label, const std::string xaxis, const std::string units,
  ...
  HadronVariable(
      const std::string label, const std::string xaxis, std::string units,
