...
#include "PlotUtils/WeightFunctions.h"
  ...
  virtual double GetTpiFResidual(const int hadron, const bool MBR = false) const;
  ...
  double Calct(const double epi, const double emu, const double pzpi, const double pzmu, const double pxpi, const double pxmu, const double pypi, const double pymu) const;
