...
DATE="20210306"
PNFS_TOPDIR="/pnfs/minerva/persistent/users/granados/MADtuplas"
BLUE_TOPDIR="/minerva/data/users/granados"
INV="v22r1p1"

indir_format_str="${PNFS_TOPDIR}/merged/%s/%s"
outfile_format_str="${BLUE_TOPDIR}/MAD_ana_plists/%s/%s_%s_plist.txt"
outfile_xrootd_format_str="${BLUE_TOPDIR}/MAD_ana_plists/%s/%s_%s_xrootd_plist.txt"
